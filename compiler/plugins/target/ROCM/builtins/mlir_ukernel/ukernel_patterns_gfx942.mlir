...
// This pattern matches a medium-sized expanded matmul-like operation and
// annotates it with ukernel descriptor and configuration attributes.
pdl.pattern @annotate_inner_tiled_f8_medium_expanded : benefit(1) {
  %elemtypes = pdl.attribute = [f8E4M3FNUZ, f8E4M3FNUZ, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  %lhs_cast_type = pdl.type : tensor<1x?x8x4x4x4x2x8xf8E4M3FNUZ>
  pdl.apply_native_constraint "matchCastCompatibleType"(%lhs, %lhs_cast_type : !pdl.value, !pdl.type)
  %rhs_cast_type = pdl.type : tensor<1x?x4x2x4x16x2x8xf8E4M3FNUZ>
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_dt_medium_f8_expanded", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
    ...
    %builtin_attr = pdl.attribute = "rocm.builtin_name"
    %builtin_annotation = pdl.attribute = "iree_uk_amdgpu_dt_matmul_f8.mlir"
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %builtin_attr, %builtin_annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
  }
}

pdl.pattern @annotate_inner_tiled_f8_medium_subgroup_n8 : benefit(1) {
  %elemtypes = pdl.attribute = [f8E4M3FNUZ, f8E4M3FNUZ, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_dt_medium_f8_expanded_subgroup_n8_reduce_dims", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f8_medium_subgroup_n8_intrinsic_m16 : benefit(1) {
  %elemtypes = pdl.attribute = [f8E4M3FNUZ, f8E4M3FNUZ, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  %lhs_cast_type = pdl.type : tensor<?x?x16x4x4x4x2x8xf8E4M3FNUZ>
  pdl.apply_native_constraint "matchCastCompatibleType"(%lhs, %lhs_cast_type : !pdl.value, !pdl.type)
  %rhs_cast_type = pdl.type : tensor<?x?x8x2x4x16x2x8xf8E4M3FNUZ>
  pdl.apply_native_constraint "matchCastCompatibleType"(%rhs, %rhs_cast_type : !pdl.value, !pdl.type)
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_dt_medium_f8_expanded_subgroup_n8_intrinsic_m16", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f16_medium_subgroup_n8 : benefit(1) {
  %elemtypes = pdl.attribute = [f16, f16, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  %lhs_cast_type = pdl.type : tensor<?x?x8x4x4x4x2x4xf16>
  pdl.apply_native_constraint "matchCastCompatibleType"(%lhs, %lhs_cast_type : !pdl.value, !pdl.type)
  %rhs_cast_type = pdl.type : tensor<?x?x8x2x4x16x2x4xf16>
  pdl.apply_native_constraint "matchCastCompatibleType"(%rhs, %rhs_cast_type : !pdl.value, !pdl.type)
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_dt_medium_f16_subgroup_n8_double_buffer", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f16_medium_subgroup_n8_intrinsic_m16 : benefit(1) {
  %elemtypes = pdl.attribute = [f16, f16, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  %lhs_cast_type = pdl.type : tensor<?x?x16x4x4x4x2x4xf16>
  pdl.apply_native_constraint "matchCastCompatibleType"(%lhs, %lhs_cast_type : !pdl.value, !pdl.type)
  %rhs_cast_type = pdl.type : tensor<?x?x8x2x4x16x2x4xf16>
  pdl.apply_native_constraint "matchCastCompatibleType"(%rhs, %rhs_cast_type : !pdl.value, !pdl.type)
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_dt_medium_f16_subgroup_n8_intrinsics_m16_split", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f16_medium_subgroup_n8_intrinsic_n4 : benefit(1) {
  %elemtypes = pdl.attribute = [f16, f16, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  %lhs_cast_type = pdl.type : tensor<?x?x8x4x4x4x2x4xf16>
  pdl.apply_native_constraint "matchCastCompatibleType"(%lhs, %lhs_cast_type : !pdl.value, !pdl.type)
  %rhs_cast_type = pdl.type : tensor<?x?x8x4x4x16x2x4xf16>
  pdl.apply_native_constraint "matchCastCompatibleType"(%rhs, %rhs_cast_type : !pdl.value, !pdl.type)
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_dt_medium_f16_subgroup_n8_intrinsics_n4", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f16_medium_subgroup_n8_intrinsic_m16_n4 : benefit(1) {
  %elemtypes = pdl.attribute = [f16, f16, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_dt_medium_f16_subgroup_n8_intrinsics_m16_intrinsics_n4_split", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f16_medium_subgroup_m2_n4_intrinsic_n4 : benefit(1) {
  %elemtypes = pdl.attribute = [f16, f16, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  %lhs_cast_type = pdl.type : tensor<?x?x2x8x4x4x4x2x4xf16>
  pdl.apply_native_constraint "matchCastCompatibleType"(%lhs, %lhs_cast_type : !pdl.value, !pdl.type)
  %rhs_cast_type = pdl.type : tensor<?x?x4x4x4x16x2x4xf16>
  pdl.apply_native_constraint "matchCastCompatibleType"(%rhs, %rhs_cast_type : !pdl.value, !pdl.type)
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_dt_medium_f16_subgroup_m2_n4_intrinsics_n4", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f16_medium_subgroup_m2_n4_intrinsic_k1_n4 : benefit(1) {
  %elemtypes = pdl.attribute = [f16, f16, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  // %generic = pdl.result 0 of %generic_op
  // %transpose_out = pdl.operand : %out_type
  // %transpose_op = pdl.operation "linalg.generic" (%generic, %transpose_out : !pdl.value, !pdl.value) -> (%out_type : !pdl.type)
  ...
  pdl.rewrite {
    ...
    // %annotation_remove = pdl.attribute = #iree_codegen.ukernel_descriptor<"remove_transpose", tensor>
    // pdl.apply_native_rewrite "annotateOperation"(%transpose_op, %attr_name, %annotation_remove : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f8_medium_subgroup_m2_n4_intrinsic_k1_n4 : benefit(1) {
  %elemtypes = pdl.attribute = [f8E4M3FNUZ, f8E4M3FNUZ, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_medium_f8_expanded_data_tiling", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f8_medium_subgroup_m1_n8_intrinsic_m8_n2_k2 : benefit(1) {
  %elemtypes = pdl.attribute = [f8E4M3FNUZ, f8E4M3FNUZ, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_medium_f8_expanded_data_tiling_zhewen_old", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f8_medium_subgroup_m1_n8_intrinsic_m8_n2_k2_outer2 : benefit(10) {
  %elemtypes = pdl.attribute = [f8E4M3FNUZ, f8E4M3FNUZ, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_medium_f8_expanded_data_tiling_zhewen_old_outer_k2", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f8_medium_subgroup_m1_n8_intrinsic_m8_n2_k1 : benefit(1) {
  %elemtypes = pdl.attribute = [f8E4M3FNUZ, f8E4M3FNUZ, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  %lhs_cast_type = pdl.type : tensor<?x?x8x4x4x4x8xf8E4M3FNUZ>
  pdl.apply_native_constraint "matchCastCompatibleType"(%lhs, %lhs_cast_type : !pdl.value, !pdl.type)
  %rhs_cast_type = pdl.type : tensor<?x?x8x2x4x16x8xf8E4M3FNUZ>
  pdl.apply_native_constraint "matchCastCompatibleType"(%rhs, %rhs_cast_type : !pdl.value, !pdl.type)
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_medium_f8_expanded_data_tiling_zhewen_old_outer_k", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f8_large_subgroup_m1_n8_intrinsic_m8_n2_k1 : benefit(2) {
  %elemtypes = pdl.attribute = [f8E4M3FNUZ, f8E4M3FNUZ, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_large_f8_expanded_data_tiling_zhewen_old_outer_k", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f8_medium_subgroup_m1_n8_intrinsic_m16_n2_k1 : benefit(1) {
  %elemtypes = pdl.attribute = [f8E4M3FNUZ, f8E4M3FNUZ, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2) -> (d0, d2)>,
    affine_map<(d0, d1, d2) -> (d1, d2)>,
  ...
  %lhs_cast_type = pdl.type : tensor<?x?x16x4x4x4x8xf8E4M3FNUZ>
  pdl.apply_native_constraint "matchCastCompatibleType"(%lhs, %lhs_cast_type : !pdl.value, !pdl.type)
  %rhs_cast_type = pdl.type : tensor<?x?x8x2x4x16x8xf8E4M3FNUZ>
  pdl.apply_native_constraint "matchCastCompatibleType"(%rhs, %rhs_cast_type : !pdl.value, !pdl.type)
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_medium_f8_expanded_data_tiling_zhewen_old_outer_k_inner_m16", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_inner_tiled_f8_large_subgroup_m2_n4_intrinsic_k1_n4 : benefit(2) {
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"pingpong_large_f8_expanded_data_tiling", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
