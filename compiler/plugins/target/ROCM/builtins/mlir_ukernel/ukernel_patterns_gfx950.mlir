...
pdl.pattern @annotate_inner_tiled_f8E4M3FN_medium : benefit(0) {
  %lhs_type = pdl.type
  %rhs_type = pdl.type
  %out_type = pdl.type
  ...
  %c1 = pdl.attribute = 1
  %c2 = pdl.attribute = 2
  pdl.apply_native_constraint "dimIsBound"(%out_init, %c0, %c2, %empty : !pdl.value, !pdl.attribute, !pdl.attribute, !pdl.attribute)
