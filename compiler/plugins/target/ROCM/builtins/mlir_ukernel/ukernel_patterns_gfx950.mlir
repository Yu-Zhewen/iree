...
pdl.pattern @annotate_scaled_matmul_like_f4E2M1FN_m64_n128_k512 : benefit(2) {
  ...
  pdl.apply_native_constraint "dimIsMultipleOf"(%lhs, %c0, %c64 : !pdl.value, !pdl.attribute, !pdl.attribute)
  pdl.apply_native_constraint "dimIsMultipleOf"(%lhs, %c1, %c8 : !pdl.value, !pdl.attribute, !pdl.attribute)
  pdl.apply_native_constraint "dimIsMultipleOf"(%rhs, %c0, %c64 : !pdl.value, !pdl.attribute, !pdl.attribute)
  pdl.apply_native_constraint "dimIsMultipleOf"(%rhs, %c1, %c8 : !pdl.value, !pdl.attribute, !pdl.attribute)

  pdl.rewrite {
    // Call the C++ "annotateOperation" utility to add the attributes to the matched linalg.generic op.
    // This modifies the operation in-place.

    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"scaled_matmul_f4f4f32_m64_n128_k512", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
    ...
    %builtin_attr = pdl.attribute = "rocm.builtin_name"
    %builtin_annotation = pdl.attribute = "iree_uk_amdgpu_scaled_matmul_f4E2M1FN_m64_n128_k512.mlir"
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %builtin_attr, %builtin_annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
  }
}


pdl.pattern @annotate_scaled_matmul_like_f4E2M1FN_m64_n64_k512 : benefit(1) {
  %elemtypes = pdl.attribute = [f4E2M1FN, f4E2M1FN, f8E8M0FNU, f8E8M0FNU, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2, d3) -> (d0, d2, d3)>,
    affine_map<(d0, d1, d2, d3) -> (d1, d2, d3)>,
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"scaled_matmul_f4f4f32_m64_n64_k512", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
    ...
    %builtin_attr = pdl.attribute = "rocm.builtin_name"
    %builtin_annotation = pdl.attribute = "iree_uk_amdgpu_scaled_matmul_f4E2M1FN_m64_n64_k512.mlir"
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %builtin_attr, %builtin_annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
  }
}

pdl.pattern @annotate_scaled_matmul_like_f4E2M1FN_m64_n64_k1024 : benefit(1) {
  %elemtypes = pdl.attribute = [f4E2M1FN, f4E2M1FN, f8E8M0FNU, f8E8M0FNU, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2, d3) -> (d0, d2, d3)>,
    affine_map<(d0, d1, d2, d3) -> (d1, d2, d3)>,
...
pdl.pattern @annotate_scaled_matmul_like_f4E2M1FN_m8_n128_k1024 : benefit(1) {
  %elemtypes = pdl.attribute = [f4E2M1FN, f4E2M1FN, f8E8M0FNU, f8E8M0FNU, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2, d3) -> (d0, d2, d3)>,
    affine_map<(d0, d1, d2, d3) -> (d1, d2, d3)>,
  ...
  %c1 = pdl.attribute = 1
  %c8 = pdl.attribute = 8
  %c32 = pdl.attribute = 32
  %c128 = pdl.attribute = 128

  pdl.apply_native_constraint "dimIsMultipleOf"(%lhs, %c0, %c8 : !pdl.value, !pdl.attribute, !pdl.attribute)
  pdl.apply_native_constraint "dimIsMultipleOf"(%lhs, %c1, %c32 : !pdl.value, !pdl.attribute, !pdl.attribute)
  pdl.apply_native_constraint "dimIsMultipleOf"(%rhs, %c0, %c128 : !pdl.value, !pdl.attribute, !pdl.attribute)
  pdl.apply_native_constraint "dimIsMultipleOf"(%rhs, %c1, %c32 : !pdl.value, !pdl.attribute, !pdl.attribute)
  ...
  pdl.rewrite {
    ...
    %builtin_attr = pdl.attribute = "rocm.builtin_name"
    %builtin_annotation = pdl.attribute = "iree_uk_amdgpu_scaled_matmul_f4E2M1FN_m8_n128_k1024.mlir"
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %builtin_attr, %builtin_annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
  }
}

pdl.pattern @annotate_scaled_matmul_like_f4E2M1FN_m8_n64_k2048 : benefit(1) {
  %elemtypes = pdl.attribute = [f4E2M1FN, f4E2M1FN, f8E8M0FNU, f8E8M0FNU, f32]
  %imaps = pdl.attribute = [
    affine_map<(d0, d1, d2, d3) -> (d0, d2, d3)>,
    affine_map<(d0, d1, d2, d3) -> (d1, d2, d3)>,
  ...
  pdl.rewrite {
    ...
    %builtin_attr = pdl.attribute = "rocm.builtin_name"
    %builtin_annotation = pdl.attribute = "iree_uk_amdgpu_scaled_matmul_f4E2M1FN_m8_n64_k2048.mlir"
    pdl.apply_native_rewrite "annotateOperation"(%generic_op, %builtin_attr, %builtin_annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
  }
}

pdl.pattern @annotate_dt_scaled_matmul_like_f4E2M1FN_m32_n64_k2048 : benefit(1) {
  %lhs_type = pdl.type
  %rhs_type = pdl.type
  %lhs_scale_type = pdl.type
  %rhs_scale_type = pdl.type
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"dt_scaled_matmul_f4f4f32_m32_n64_k2048", tensor>
    ...
    %builtin_attr = pdl.attribute = "rocm.builtin_name"
    %builtin_annotation = pdl.attribute = "iree_uk_amdgpu_dt_scaled_matmul_f4E2M1FN_m32_n64_k2048.mlir"
...
pdl.pattern @annotate_dt_scaled_matmul_like_f4E2M1FN_m64_n128_k512 : benefit(1) {
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"dt_scaled_matmul_f4f4f32_m64_n128_k512", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%inner_tiled_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
    ...
    %builtin_attr = pdl.attribute = "rocm.builtin_name"
    %builtin_annotation = pdl.attribute = "iree_uk_amdgpu_dt_scaled_matmul_f4E2M1FN_m64_n128_k512.mlir"
    pdl.apply_native_rewrite "annotateOperation"(%inner_tiled_op, %builtin_attr, %builtin_annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
  }
}

pdl.pattern @annotate_dt_scaled_matmul_like_f4E2M1FN_m128_n128_k256 : benefit(1) {
  %lhs_type = pdl.type
  %rhs_type = pdl.type
  %lhs_scale_type = pdl.type
  %rhs_scale_type = pdl.type
  ...
  %lhs_cast_type = pdl.type : tensor<?x?x1x8x2x4x16x32xf4E2M1FN>
  pdl.apply_native_constraint "matchCastCompatibleType"(%lhs, %lhs_cast_type : !pdl.value, !pdl.type)
  %rhs_cast_type = pdl.type : tensor<?x?x1x4x2x2x4x16x32xf4E2M1FN>
  pdl.apply_native_constraint "matchCastCompatibleType"(%rhs, %rhs_cast_type : !pdl.value, !pdl.type)
      %lhs_scale_cast_type = pdl.type : tensor<?x?x8x4x16x2xf8E8M0FNU>
      pdl.apply_native_constraint "matchCastCompatibleType"(%lhs_scale, %lhs_scale_cast_type : !pdl.value, !pdl.type)
      %rhs_scale_cast_type = pdl.type : tensor<?x?x4x2x4x16x2xf8E8M0FNU>
      pdl.apply_native_constraint "matchCastCompatibleType"(%rhs_scale, %rhs_scale_cast_type : !pdl.value, !pdl.type)
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"dt_scaled_matmul_f4f4f32_m128_n128_k256", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%inner_tiled_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
...
pdl.pattern @annotate_dt_scaled_matmul_like_f4E2M1FN_m128_n256_k256 : benefit(2) {
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"dt_scaled_matmul_f4f4f32_m128_n256_k256", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%inner_tiled_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
    ...
    %builtin_attr = pdl.attribute = "rocm.builtin_name"
    %builtin_annotation = pdl.attribute = "iree_uk_amdgpu_dt_scaled_matmul_f4E2M1FN_m128_n256_k256.mlir"
    pdl.apply_native_rewrite "annotateOperation"(%inner_tiled_op, %builtin_attr, %builtin_annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
  }
}

pdl.pattern @annotate_dt_scaled_matmul_like_f4E2M1FN_m256_n256_k128 : benefit(1) {
  %lhs_type = pdl.type
  %rhs_type = pdl.type
  %lhs_scale_type = pdl.type
  %rhs_scale_type = pdl.type
  ...
  %lhs_cast_type = pdl.type : tensor<?x?x1x2x8x4x16x32xf4E2M1FN>
  pdl.apply_native_constraint "matchCastCompatibleType"(%lhs, %lhs_cast_type : !pdl.value, !pdl.type)
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"dt_scaled_matmul_f4f4f32_m256_n256_k128", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%inner_tiled_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
    ...
    %builtin_attr = pdl.attribute = "rocm.builtin_name"
    %builtin_annotation = pdl.attribute = "iree_uk_amdgpu_dt_scaled_matmul_f4E2M1FN_m256_n256_k128.mlir"
    pdl.apply_native_rewrite "annotateOperation"(%inner_tiled_op, %builtin_attr, %builtin_annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
  }
}

pdl.pattern @annotate_dt_scaled_matmul_like_f4E2M1FN_m256_n256_k256 : benefit(1) {
  %lhs_type = pdl.type
  %rhs_type = pdl.type
  %lhs_scale_type = pdl.type
  %rhs_scale_type = pdl.type
...
pdl.pattern @annotate_dt_scaled_matmul_like_f4E2M1FN_m64_n64_k512 : benefit(1) {
  ...
  pdl.rewrite {
    ...
    %annotation = pdl.attribute = #iree_codegen.ukernel_descriptor<"dt_scaled_matmul_f4f4f32_m64_n64_k512", tensor>
    pdl.apply_native_rewrite "annotateOperation"(%inner_tiled_op, %attr_name, %annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
    ...
    %builtin_attr = pdl.attribute = "rocm.builtin_name"
    %builtin_annotation = pdl.attribute = "iree_uk_amdgpu_dt_scaled_matmul_f4E2M1FN_m64_n64_k512.mlir"
    pdl.apply_native_rewrite "annotateOperation"(%inner_tiled_op, %builtin_attr, %builtin_annotation : !pdl.operation, !pdl.attribute, !pdl.attribute)
  }
}
