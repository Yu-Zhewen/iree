...
python mlir_ukernel_gen.py iree_uk_amdgpu_dt_scaled_matmul_f4E2M1FN.mlir.in \
  -D BENEFIT=1 ELEM_TYPE=f4E2M1FN INTRINSIC=MFMA_SCALE_F32_16x16x128_B32 \
...
python mlir_ukernel_gen.py iree_uk_amdgpu_dt_matmul_large.mlir.in \
  -D BENEFIT=1 ELEM_TYPE=f16 INTRINSIC=MFMA_F32_16x16x16_F16 \
...
```bash
python mlir_ukernel_gen.py iree_uk_amdgpu_dt_matmul_large.mlir.in \
  -D BENEFIT=2 ELEM_TYPE=f8E4M3FNUZ INTRINSIC=MFMA_F32_16x16x32_F8E4M3FNUZ \
     INTRINSICS_M=8 INTRINSICS_N=4 INTRINSICS_K=1 SUBGROUPS_M=2 SUBGROUPS_N=4 ARCH=gfx942 \
...
python mlir_ukernel_gen.py iree_uk_amdgpu_dt_matmul_medium.mlir.in \
  -D BENEFIT=1 ELEM_TYPE=f8E4M3FNUZ INTRINSIC=MFMA_F32_16x16x32_F8E4M3FNUZ \
...
```bash
python mlir_ukernel_gen.py iree_uk_amdgpu_dt_matmul_large.mlir.in \
  -D BENEFIT=0 ELEM_TYPE=f8E4M3FN INTRINSIC=MFMA_F32_16x16x32_F8E4M3FN \
...
```bash
python mlir_ukernel_gen.py iree_uk_amdgpu_dt_matmul_medium.mlir.in \
  -D BENEFIT=1 ELEM_TYPE=f8E4M3FN INTRINSIC=MFMA_F32_16x16x128_F8E4M3FN \
     INTRINSICS_M=4 INTRINSICS_N=2 INTRINSICS_K=1 SUBGROUPS_M=2 SUBGROUPS_N=4 ARCH=gfx950 \
     SIZE_MIN_0=32 \
...
```bash
python mlir_ukernel_gen.py iree_uk_amdgpu_matmul_large.mlir.in \
  -D BENEFIT=1 ELEM_TYPE=bf16 INTRINSIC=MFMA_F32_16x16x16_BF16 \
     INTRINSICS_M=8 INTRINSICS_N=4 INTRINSICS_K=1 \
     SUBGROUPS_M=2 SUBGROUPS_N=4 ARCH=gfx942 \
